    <div class="col-12 w-full">
        ...
        <div class="mb-4">
            ...
            <button class="editButton" wire:click.prevent="getWorkshops('canceled')" name="past">TN Storno</button>
            ...
            <div class="ml-6 mr-6 mb-12">
                <table class="table table-striped table-sm data-table table-hover" id="trainer_workshops_table">
                    ...
                    <tr class="border-black">
                        <th class="tableHeader" wire:click.prevent="sorting('title')">{{ trans('clients.labels.workshopTitle') }}</th>
                        <th class="tableHeader" wire:click.prevent="sorting('date')">{{ trans('clients.labels.workshopDate') }}</th>
                        <th class="tableHeader" wire:click.prevent="sorting('location')">{{ trans('clients.labels.workshopLocation') }}</th>
                        <th class="tableHeader" wire:click.prevent="sorting('clients')">{{ trans('clients.labels.workshopClients') }}</th>
                        <th class="tableHeader" wire:click.prevent="sorting('canceled')">{{ trans('clients.labels.workshopCanceled') }}</th>
                        <th class="tableHeader">{{ trans('clients.labels.workshopCanceledBy') }}</th>
                        <th></th>
                    </tr>
                    </thead>
        ...
        @else
            <div class="ml-6 mr-6 mb-12">{{trans('clients.labels.noWorkshops')}}</div>
        @endif
    </div>
