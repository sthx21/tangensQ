<div class="col-12 w-full">
    ...
    @if (count($workshops) > 0  ||  count($allCanceledWorkshops) > 0)
        <div class="ml-md-6 mr-md-6 mb-md-12 mb-4">
            <table class="table table-striped table-sm data-table table-hover" id="trainer_workshops_table">
                ...
                @foreach($workshops as $workshop)
                    <tr>
                        ...
                        <td>
                            {{$workshop->canceled_by}}<br>{{$workshop->tn_canceled ?? ''}}</td>
                ...
                @endforeach
                    ...
                    @foreach($allCanceledWorkshops as $workshop)
                        <tr>
                            <td style="width: max-content">
                                <a href="{{url('workshops/'.$workshop->slug)}}">{{$workshop->title}}</a>
                            </td>
