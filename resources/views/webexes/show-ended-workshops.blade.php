<x-app-layout>
    <x-slot name="header">
        ...
        <div>
            ...
            <x-button-link :link="'/workshops/Storniert'" :class="'btn-danger'" :title="trans('workshops.tooltips.canceled')">{{ trans('workshops.buttons.canceledWorkshops') }}</x-button-link>
        </div>
